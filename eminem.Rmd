...
# Overlay a criterion line for density=1.0
# a significance line at the traditional figure of p=0.05
abline(h=1.0, lty=4)
abline(v=0.05, lty=4)
```
...
# Histogram of the p-values, density plot, and criterion lines
par(mar=c(4, 4, 0.5, 2)) # (bottom, left, top, right)
hist(p.values, xlim=c(0, 1),
     breaks=min(20, n.replications/10),
     main=NA, freq=FALSE)
...
At reasonable sample sizes (about 30 _per color_), this test appears to
